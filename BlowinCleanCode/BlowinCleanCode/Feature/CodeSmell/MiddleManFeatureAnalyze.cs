...
namespace BlowinCleanCode.Feature.CodeSmell
{
    public sealed class MiddleManFeatureAnalyze : TypeDeclarationSyntaxNodeAnalyzerBase
    {
        ...
        private static bool Skip(SyntaxNodeAnalysisContext context, TypeDeclarationSyntax syntaxNode,
        ...
        private static bool AllMethodsUseOneFieldWithSingleCall(ImmutableArray<MethodDeclarationSyntax> methods, ISymbol typeField,
